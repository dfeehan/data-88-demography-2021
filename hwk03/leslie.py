...
_unpd_asfr = Table.read_table('data/unpd_asfr_cleaned.csv')
_unpd_lt = Table.read_table('data/unpd_life_tables_cleaned.csv')
_unpd_pop = Table.read_table('data/unpd_f_pop_byage_cleaned.csv')
